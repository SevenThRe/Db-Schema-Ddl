...
Type-check and regression tests passed. The ship gate intentionally exited blocked and wrote the new release-exit artifacts.
...
- `artifacts/release-verification/release-exit-checklist-2026-04-17T02-11-01-818Z.json` currently reports:
...
- `artifacts/release-verification/release-exit-checklist-2026-04-17T02-11-01-818Z.json` classifies packaged smoke as:
  - `status: current`
...
- `artifacts/release-verification/ship-gate-2026-04-17T02-11-01-818Z.json` contains:
  - `shipBlockers`
  - `missingEvidence`
  - `staleEvidence`
...
- The latest MySQL live artifact is not a passing proof run; it failed before connection because no matching saved connection was available.
